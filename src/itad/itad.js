...
function GetEncodedName(gameName) {
...
export { GetInfoAboutBundles, GetOverview, GetInfoAboutGame, GetPlain, FindGame, GetEncodedName, GetMap, }
...
//     async GetMap(shop = 'steam') {
//         return axios.get(`https://api.isthereanydeal.com/v01/game/map/?key=${this.apiKey}&shop=${shop}`)
//     }
// }
